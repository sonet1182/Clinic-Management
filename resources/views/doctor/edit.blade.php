...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="needs-validation" action="{{ route('doctors.update',$post->id) }}" method="POST" novalidate
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('designation') is-invalid @enderror"
                            id="validationCustom01" name="designation" placeholder="Enter designation"
                            value="{{ $post->designation ?? old('designation') }}" required>
                        <div class="invalid-feedback">
                            @error('designation')
                                {{ $message }}
                            @enderror
