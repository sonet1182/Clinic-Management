                                    ...
                                    <td
                                        ...
                                        <table style="table-layout: fixed;width:-webkit-fill-available;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: right;">{{ $receipt->patient_age ?? '-' }}</td>
                                            </tr>
                                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right; padding-bottom: 13px;">
                                        ...
                                        <p style="font-weight: 700; color: #1A1C21;">
                                            {{ $receipt->created_at ? $receipt->created_at->format('d M, Y') : '' }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                        <table style="width: 100%;border-spacing: 0;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-block: 12px;" col-span="1"></td>
                                                    <td style="padding-block: 12px; text-align: end;" col-span="1">
                                                        Total Fee:</td>
                                                    <td style="padding-block: 12px; text-align: right;" col-span="1">
